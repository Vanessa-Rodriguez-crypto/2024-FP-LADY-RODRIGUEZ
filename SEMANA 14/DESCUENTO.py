...
monto1 = 150.00  # Ejemplo de monto de compra
...
# Segunda llamada con el monto de la c  ompra y el porcentaje de descuento especificado (por ejemplo, 15%)
monto2 = 300.00  # Otro ejemplo de monto de compra
